...
#define Direct_ComSeg_SetIn {IOSTA |= 0x07;}		//全部设置为输入口

#define Led3_OutHi	{IOSTA &= 0xFB;LED3=1;}
#define Led3_OutLo	{IOSTA &= 0xFB;LED3=0;}
#define Led2_OutHi	{IOSTA &= 0xfd;LED2=1;}
#define Led2_OutLo	{IOSTA &= 0xfd;LED2=0;}
#define Led1_OutHi	{IOSTA &= 0xfe;LED1=1;}
#define Led1_OutLo	{IOSTA &= 0xfe;LED1=0;}


#define Led3_In	{IOSTA |= 0x04;}
#define Led2_In	{IOSTA |= 0x02;}
#define Led1_In	{IOSTA |= 0x01;}

#define CHRG_SHIFT_In {IOSTB |= 0x01;}
#define CHRG_SHIFT_OutLo {IOSTB &= 0xfe;CHRG_SHIFT = 0;}
